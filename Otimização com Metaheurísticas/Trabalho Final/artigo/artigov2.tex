...
%─────────────────────────────────────────────────────────────────────────────
\section{Fun\c{c}\~{o}es Benchmark}\label{sec:benchmark}
...
Para cada combinação de algoritmo,
...
algoritmos, essas mesmas configurações foram aplicadas variando a dimensão [30,50,100]D garantindo comparação equitativa do custo
